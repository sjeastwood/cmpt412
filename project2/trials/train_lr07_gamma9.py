...
optimizer = optim.SGD(net.parameters(), lr=0.07, momentum=0.9)#, dampening=0, weight_decay=0.000001)
...
plt.xticks(np.arange(EPOCHS, dtype=int))
plt.grid(True)
plt.savefig("plot_with_lr_annealing_07_gamma_9.png")
plt.close(fig)
...
with open('submission_netid_lr_annealing_07_gamma_9.csv', 'w') as csvfile:
