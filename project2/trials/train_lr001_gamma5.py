...
optimizer = optim.SGD(net.parameters(), lr=0.001, momentum=0.9)#, dampening=0, weight_decay=0.000001)
stepper = optim.lr_scheduler.StepLR(optimizer,10,0.5)
...
plt.xticks(np.arange(EPOCHS, dtype=int))
plt.grid(True)
plt.savefig("plot_with_lr_annealing_001_gamma_5.png")
plt.close(fig)
...
with open('submission_netid_lr_annealing_001_gamma_5.csv', 'w') as csvfile:
