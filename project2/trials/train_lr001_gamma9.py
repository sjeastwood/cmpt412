...
stepper = optim.lr_scheduler.StepLR(optimizer,10,0.9)
...
plt.xticks(np.arange(EPOCHS, dtype=int))
plt.grid(True)
plt.savefig("plot_with_lr_annealing_001_gamma_9.png")
plt.close(fig)
...
with open('submission_netid_lr_annealing_001_gamma_9.csv', 'w') as csvfile:
