...
class BaseNet(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(3, 20, 3) #20
        self.norm1 = nn.BatchNorm2d(20)

        self.conv2 = nn.Conv2d(20, 64, 3) #64
        self.norm2 = nn.BatchNorm2d(64)

        self.conv3 = nn.Conv2d(64, 128, 3) #128
        self.norm3 = nn.BatchNorm2d(128)

        self.conv4 = nn.Conv2d(128, 256, 3) #256
        self.norm4 = nn.BatchNorm2d(256)

        self.conv5 = nn.Conv2d(256, 512, 3) #512
        self.norm5 = nn.BatchNorm2d(512)

        self.conv6 = nn.Conv2d(512, 1024, 3) #1024
...
#             nn.ReLU(inplace=True),
    ...
    def forward(self, x):
        ...
        x = self.pool(F.relu(self.norm6(self.conv6(F.relu(self.norm5(self.conv5(x))))))) #12 -> 10 -> 8 -> 4 -> output
...
optimizer = optim.SGD(net.parameters(), lr=0.01, momentum=0.9)#, dampening=0, weight_decay=0.000001)
...
plt.xticks(np.arange(EPOCHS, dtype=int))
plt.grid(True)
plt.savefig("plot_with_lr_annealing_01.png")
plt.close(fig)
...
with open('submission_netid_01.csv', 'w') as csvfile:
