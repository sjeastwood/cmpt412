...
stepper = optim.lr_scheduler.StepLR(optimizer,15,0.5)
...
plt.xticks(np.arange(EPOCHS, dtype=int))
plt.grid(True)
plt.savefig("plot_with_lr_annealing_05_step15.png")
plt.close(fig)
...
with open('submission_netid_05_step15.csv', 'w') as csvfile:
